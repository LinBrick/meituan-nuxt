    ...
    <div class="footer-content">
      <div class="footer-link clearfix">
        <div class="footer-column">
          <dl>
            ...
            <dd>
              <a rel="nofollow" href="#" target="_blank">隐私政策</a>
            </dd>
            <dd>
              <a rel="nofollow" href="#" target="_blank">反诈骗公告</a>
            </dd>
            <dd>
              <a rel="nofollow" href="#" target="_blank">消费者权益保障</a>
            </dd>
          </dl>
          <dl>
            <dt>
            ...
            <dd>
              <a href="#" target="_blank">美团配送</a>
            </dd>
            <dd>
              <a href="#" target="_blank">美团云</a>
            </dd>
            <dd>
        ...
        <div class="footer-column">
          <dl>
            ...
            <dd>
              <a rel="nofollow" href="#" target="_blank">境内度假商家入驻</a>
            </dd>
            <dd>
              <a rel="nofollow" href="#?source=mt" target="_blank">综合商家入驻</a>
            </dd>
            <dd>
            ...
            <dd>
              <a rel="nofollow" href="#" target="_blank">美团闪购商家入驻</a>
            </dd>
          </dl>
        </div>
        <div class="footer-column">
          ...
          <dl>
            ...
            <dd>
              <a rel="nofollow" href="#" target="_blank">规则中心</a>
            </dd>
            <dd>
              <a rel="nofollow" href="#" target="_blank">规则目录</a>
            </dd>
            <dd>
              <a rel="nofollow" href="#" target="_blank">规则评议院</a>
            </dd>
          </dl>
        </div>
        <div class="footer-column">
          <dl>
            ...
            <dd>
              <a rel="nofollow" href="#" target="_blank">美团新浪微博</a>
            </dd>
          </dl>
          <dl>
            <dt>
            ...
            <dd>
              <a rel="nofollow" href="#" target="_blank">投资者关系</a>
            </dd>
            <dd>
          ...
          <dl>
            ...
            <dd>
              <a rel="nofollow" href="#" target="_blank">知识产权维权平台</a>
            </dd>
          </dl>
        </div>
        <div class="footer-column">
          ...
          <dl>
            <dt>
              <a rel="nofollow" href="#" target="_blank">商家自助入驻美团入口</a>
            </dt>
          </dl>
          <dl>
            <dt>
              <a rel="nofollow" href="#" target="_blank">供应商注册入口</a>
            </dt>
          </dl>
        </div>
      </div>
      <div class="footer-copyright clearfix">
        <div class="footer-copyright-left">
          <p>&copy;美团网团购 #<a href="#" style="margin-left: 20px;">京ICP证070791号</a><a href="#">京ICP备10211739号</a></p>
          <p><a href="#" target="_blank">广播电视节目制作经营许可证（京）字第03889号</a></p>
          <p><a href="#" target="_blank">食品经营许可证</a><a href="#" target="_blank">互联网药品信息服务资格证</a></p>
